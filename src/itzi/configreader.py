...
class ConfigReader:
    ...
    def __set_defaults(self):
        ...
        self.sim_param = {
            ...
            "inf_model": InfiltrationModel.NULL,
        }
    ...
    def check_inf_maps(self):
        ...
        if not self.input_map_names[inf_k] and not ga_any:
            self.sim_param["inf_model"] = InfiltrationModel.NULL
        elif self.input_map_names[inf_k] and not ga_any:
            self.sim_param["inf_model"] = InfiltrationModel.CONSTANT
        ...
        # check if all maps for Green-Ampt are presents
            ...
            self.sim_param["inf_model"] = InfiltrationModel.GREEN_AMPT
        return self
